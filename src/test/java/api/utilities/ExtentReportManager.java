...
//		}s
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * try {
		 * 
		 * @SuppressWarnings("deprecation") URL url = new
		 ...
		 * DefaultAuthenticator("apoorvapandey1906@gmail.com","Apoorva@124"));
		 * email.setSSLOnConnect(true); email.setFrom("apoorvapandey1906@gmail.com");
		 * //Sender email.setSubject("Test Results");
		 * email.setMsg("Please find Attached Report....");
		 * email.addTo("apoorvapandey1906@gmail.com"); //Receiver email.attach(url,
